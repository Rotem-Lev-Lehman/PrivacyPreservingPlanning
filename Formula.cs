...
namespace Planning
{
    public abstract class Formula
    {
        ...
        public abstract Formula RemoveUniversalQuantifiers(HashSet<Constant> lConstants, List<Predicate> lConstantPredicates, Domain d);
        ...
        public abstract Formula FilterPredicates(HashSet<Predicate> hsToRemove);
    }
}
