    ...
    class OptimalDependenciesPlanner
    {
        ...
        */
        ...
        private List<string> SendToExternalPlanners(Domain domain, Problem problem, State startState, string SymPAFilename, CancellationToken token, bool useSecondFFPath = false)
        {
            ...
            List<string> plan = externalPlanners.Plan(usingFF, usingFD, false, domain, problem, startState, null, null, Program.maxTimeInMinutes * 60 * 1000, out ans, SymPAFilename, useSecondFFPath);
            return plan;
        }
